...
# on peer0.microsoft and peer0.oracle, and uprage the chaincode on the
# channel to version 2.0, thus completing the addition of dell to the
...
echo "===================== Installing chaincode 2.0 on peer0.microsoft ===================== "
installChaincode 0 1 2.0
echo "===================== Installing chaincode 2.0 on peer0.oracle ===================== "
installChaincode 0 2 2.0

echo "===================== Upgrading chaincode on peer0.microsoft ===================== "
