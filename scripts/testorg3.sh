...
# chaincode requests through the dell peers to check that dell was
...
# Query chaincode on peer0.dell, check if the result is 90
echo "Querying chaincode on peer0.dell..."
chaincodeQuery 0 3 90

# Invoke chaincode on peer0.microsoft, peer0.oracle, and peer0.dell
echo "Sending invoke transaction on peer0.microsoft peer0.oracle peer0.dell..."
chaincodeInvoke 0 1 0 2 0 3

# Query on chaincode on peer0.dell, peer0.oracle, peer0.microsoft check if the result is 80
...
echo "Querying chaincode on peer0.oracle..."
